            ...
            <Card className="relative w-[400px] border border-cyan-700/40 bg-black/40 backdrop-blur-md text-right shadow-xl">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <Label htmlFor="username" className="text-gray-300 text-sm">نام کاربری</Label>
                    ...
                    {/* Password */}
                    <div className="space-y-1">
                        <Label htmlFor="password" className="text-gray-300 text-sm">رمز عبور</Label>
                        <div className="relative">
                            <Input
                                type="password"
                                value={password}
                ...
                <CardFooter className="flex justify-between gap-2 pt-4">
                    ...
                    >
                        ...
                        <div className="w-6 h-6 flex items-center justify-center rounded-full bg-black text-white text-xs font-bold">A</div>
                    </Button>
                </CardFooter>
            </Card>
        </div>
