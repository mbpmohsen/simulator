                    ...
                    {blueTeam.map((player) => (
                        ...
                        >
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-blue-300/70">سطح {player.level}</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Badge variant="secondary" className="flex items-center gap-1 bg-blue-800/30 text-blue-200 border-blue-700">
                ...
                <div className="flex flex-col gap-3">
                    {redTeam.map((player) => (
                        ...
                        >
                            <div className="flex flex-col">
                                <span className="font-semibold text-sm">{player.name}</span>
                                <span className="text-xs text-red-300/70">سطح {player.level}</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Badge variant="secondary" className="flex items-center gap-1 bg-red-800/30 text-red-200 border-red-700">
                                    <Sword className="w-4 h-4" /> {player.power}
                                </Badge>
                                <Badge variant="secondary" className="flex items-center gap-1 bg-red-800/30 text-red-200 border-red-700">
                                    <Shield className="w-4 h-4" /> {player.defense}
