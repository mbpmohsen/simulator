...
export default function SettingsMenu() {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-zinc-900 text-white border-green-600">
                <DropdownMenuLabel className="text-green-400">تنظیمات کلی</DropdownMenuLabel>
