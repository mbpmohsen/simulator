...
const initialTeam: Player[] = [
  { id: 1, name: "نقی معمولی", role: "برنامه نویس", xp: 156, icon: <Mouse className="w-4 h-4" />, color: "text-cyan-400" },
  { id: 2, name: "محسن بابایی", role: "تیم لید", xp: 55, icon: <Crown className="w-4 h-4" />, color: "text-emerald-400" },
  { id: 3, name: "حسن احمدی", role: "شبکه", xp: 70, icon: <Network className="w-4 h-4" />, color: "text-blue-400" },
  { id: 4, name: "اصغر فرهادی", role: "کارمند", xp: 42, icon: <User className="w-4 h-4" />, color: "text-gray-400" },
  { id: 5, name: "محمد مهاجر", role: "کارشناس IT", xp: 110, icon: <Cpu className="w-4 h-4" />, color: "text-teal-400" },
];

const initialEnemy: Player[] = [
  { id: 6, name: "احمد احمدی", role: "لید گروه", xp: 150, icon: <Gamepad2 className="w-4 h-4" />, color: "text-red-400" },
  { id: 7, name: "فاطمه حسینی", role: "تحلیل‌گر", xp: 80, icon: <Shield className="w-4 h-4" />, color: "text-rose-400" },
  { id: 8, name: "محسن محسنی", role: "هکر", xp: 95, icon: <Skull className="w-4 h-4" />, color: "text-orange-400" },
];
