    ...
    startGame: publicProcedure
        .meta({
            openapi: {
                ...
                description: 'Start the game. Ensure all configurations are complete before starting.',
            },
        })
        .input(z.void())
    ...
    configureEvents: publicProcedure
        .meta({
            openapi: {
                ...
                description: 'Configure events for a game. These are saved separately and persist until changed.',
            },
        })
    ...
    clearEvents: publicProcedure
        .meta({
            openapi: {
                ...
                description: 'Clear all events (not game-specific, affects all future games)',
            },
        })
        .input(z.void())
        .output(z.object({}))
